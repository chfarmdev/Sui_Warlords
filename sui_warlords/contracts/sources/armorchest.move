...
module sui_warlords::armorchest {    
    ...
    // Armor NFT
    public struct SuiWarlordArmorChest has key, store {
        id: UID,
        // Armor style
        style: String,        
    ...
    public struct ARMORCHEST has drop {}

    // Init to claim publisher object and create initial display configuration
    fun init(otw: ARMORCHEST, ctx: &mut TxContext) {
        let keys = vector[
            utf8(b"name"),
            utf8(b"link"),
            utf8(b"image_url"),            
        ...
        let values = vector[
            // Name references gradestring / style /slot properties "Common Plate Chest"
            utf8(b"{gradestring} {style} Chest"),
            // Link references static URL + id property
            utf8(b"https://suiwarlords.com/main/armor/chest/{id}"),
            // For `image_url` use an IPFS template + `image_url` property.
            utf8(b"ipfs://{gradestring}/{enhancements}/{style}/Chest"),            
            // Project URL
        ...
        let mut display = display::new_with_fields<SuiWarlordArmorChest>(
    ...
    public fun get_chest_armorlevelphysical(armor: &SuiWarlordArmorChest): u64 {
        armor.armorlevelphysical
    }

    public fun get_chest_armorlevelmagical(armor: &SuiWarlordArmorChest): u64 {
    ...
    // Create a new Sui Warlords COMMON Chest Armor NFT. Style, TIME payment, and COMMON payment are required fields
    // URL will be managed by a display object   
    public fun armor_mint_common_chest(
        style: String,               
        ...
        let armorstatbonus = sui_warlords::armorchest::armor_random_bonus(tempbonus);

        let mut armor = SuiWarlordArmorChest {
            id: object::new(ctx),
            style: style,                            
    ...
    // Create a new Sui Warlords UNCOMMON Chest Armor NFT. Style, TIME payment, and UNCOMMON payment are required fields
    // URL will be managed by a display object    
    public fun armor_mint_uncommon_chest(
        style: String,              
        mut payment: Coin<sui_warlords::time::TIME>,
    ...
    // Create a new Sui Warlords RARE Chest Armor NFT. Style, TIME payment, and RARE payment are required fields
    // URL will be managed by a display object     
    public fun armor_mint_rare_chest(
        style: String,              
        mut payment: Coin<sui_warlords::time::TIME>,
    ...
    // Create a new Sui Warlords Legendary Chest Armor NFT. Style, TIME payment, and LEGENDARY payment are required fields
    // URL will be managed by a display object   
    public fun armor_mint_legendary_chest(
        style: String,              
        mut payment: Coin<sui_warlords::time::TIME>,
    ...
    // Create a new Sui Warlords MYTHIC Chest Armor NFT. Style, TIME payment, and MYTHIC payment are required fields
    // URL will be managed by a display object   
    public fun armor_mint_mythic_chest(
        style: String,          
        mut payment: Coin<sui_warlords::time::TIME>,
    ...
    // Transfer Chest Armor to recipient
     public fun chest_armor_transfer(armor: SuiWarlordArmorChest, recipient: address) {
    ...
    // Enhance common chest armor function. Chance to burn item scales with enhancement level.    
    public fun chest_armor_enhance_common(
        armor: SuiWarlordArmorChest,
        accobj: &mut Account,
        mut payment: Coin<sui_warlords::time::TIME>,
        mut payment2: Coin<sui_warlords::common::COMMON>,               
        ctx: &mut TxContext,
        ...
        if (random <= chancetoburn) {
            chest_armor_burn(armor, accobj, ctx);
        }
        else {
            let mut armor2 = armor;
            chest_armor_enhance(&mut armor2);
    ...
    // Enhance uncommon chest armor function. Chance to burn item scales with enhancement level.    
    public fun chest_armor_enhance_uncommon(
        armor: SuiWarlordArmorChest,
        accobj: &mut Account,
        mut payment: Coin<sui_warlords::time::TIME>,
        mut payment2: Coin<sui_warlords::uncommon::UNCOMMON>,               
    ...
    // Enhance rare chest armor function. Chance to burn item scales with enhancement level.    
    public fun chest_armor_enhance_rare(
        armor: SuiWarlordArmorChest,
        accobj: &mut Account,
        mut payment: Coin<sui_warlords::time::TIME>,
        mut payment2: Coin<sui_warlords::rare::RARE>,               
    ...
    // Enhance legendary chest armor function. Chance to burn item scales with enhancement level.    
    public fun chest_armor_enhance_legendary(
        armor: SuiWarlordArmorChest,
        accobj: &mut Account,
        mut payment: Coin<sui_warlords::time::TIME>,
        mut payment2: Coin<sui_warlords::legendary::LEGENDARY>,               
    ...
    // Enhance mythic chest armor function. Chance to burn item scales with enhancement level.    
    public fun chest_armor_enhance_mythic(
        armor: SuiWarlordArmorChest,
        accobj: &mut Account,
        mut payment: Coin<sui_warlords::time::TIME>,
        mut payment2: Coin<sui_warlords::mythic::MYTHIC>,               
    ...
    fun chest_armor_enhance(armor: &mut SuiWarlordArmorChest) {
    ...
    public fun chest_armor_burn(armor: SuiWarlordArmorChest, accobj: &mut Account, ctx: &mut TxContext) {
        ...
        let SuiWarlordArmorChest {id, style: _, gradestring: _, grade: _, bonus: _, enhancements: _, armorlevelphysical: _, armorlevelmagical: _, strength: _, endurance: _, dexterity: _, agility: _, intelligence: _, wisdom: _, vitality: _, luck: _} = armor;
        object::delete(id);                              
    }   
}