...
module sui_warlords::armorhelmet {    
    ...
    // Armor NFT
    public struct SuiWarlordArmorHelmet has key, store {
        id: UID,
        // Armor style
        style: String,        
    ...
    public struct ARMORHELMET has drop {}

    // Init to claim publisher object and create initial display configuration
    fun init(otw: ARMORHELMET, ctx: &mut TxContext) {
        let keys = vector[
            utf8(b"name"),
            utf8(b"link"),
            utf8(b"image_url"),            
        ...
        let values = vector[
            // Name references gradestring / style /slot properties "Common Plate Helmet"
            utf8(b"{gradestring} {style} Helmet"),
            // Link references static URL + id property
            utf8(b"https://suiwarlords.com/main/armor/helmet/{id}"),
            // For `image_url` use an IPFS template + `image_url` property.
            utf8(b"ipfs://{gradestring}/{enhancements}/{style}/Helmet"),            
            // Project URL
        ...
        // Get a new Display object for the Helmet Armor type
        let mut display = display::new_with_fields<SuiWarlordArmorHelmet>(
    ...
    public fun get_helmet_armorlevelphysical(armor: &SuiWarlordArmorHelmet): u64 {
        armor.armorlevelphysical
    }

    public fun get_helmet_armorlevelmagical(armor: &SuiWarlordArmorHelmet): u64 {
    ...
    // Create a new Sui Warlords COMMON Helmet Armor NFT. Style, TIME payment, and COMMON payment are required fields
    // URL will be managed by a display object   
    public fun armor_mint_common_helmet(
        style: String,               
        ...
        let armorstatbonus = sui_warlords::armorhelmet::armor_random_bonus(tempbonus);

        let mut armor = SuiWarlordArmorHelmet {
            id: object::new(ctx),
            style: style,                            
    ...
    // Create a new Sui Warlords UNCOMMON Helmet Armor NFT. Style, TIME payment, and UNCOMMON payment are required fields
    // URL will be managed by a display object    
    public fun armor_mint_uncommon_helmet(
        style: String,              
        mut payment: Coin<sui_warlords::time::TIME>,
    ...
    // Create a new Sui Warlords RARE Helmet Armor NFT. Style, TIME payment, and RARE payment are required fields
    // URL will be managed by a display object     
    public fun armor_mint_rare_helmet(
        style: String,              
        mut payment: Coin<sui_warlords::time::TIME>,
    ...
    // Create a new Sui Warlords Legendary Helmet Armor NFT. Style, TIME payment, and LEGENDARY payment are required fields
    // URL will be managed by a display object   
    public fun armor_mint_legendary_helmet(
        style: String,              
        mut payment: Coin<sui_warlords::time::TIME>,
    ...
    // Create a new Sui Warlords MYTHIC Helmet Armor NFT. Style, TIME payment, and MYTHIC payment are required fields
    // URL will be managed by a display object   
    public fun armor_mint_mythic_helmet(
        style: String,          
        mut payment: Coin<sui_warlords::time::TIME>,
    ...
    // Transfer Helm Armor to recipient
     public fun helmet_armor_transfer(armor: SuiWarlordArmorHelmet, recipient: address) {
    ...
    // Enhance common helmet armor function. Chance to burn item scales with enhancement level.    
    public fun helmet_armor_enhance_common(
        armor: SuiWarlordArmorHelmet,
        accobj: &mut Account,
        mut payment: Coin<sui_warlords::time::TIME>,
        mut payment2: Coin<sui_warlords::common::COMMON>,               
        ctx: &mut TxContext,
        ...
        if (random <= chancetoburn) {
            helmet_armor_burn(armor, accobj, ctx);
        }
        else {
            let mut armor2 = armor;
            helmet_armor_enhance(&mut armor2);
    ...
    // Enhance uncommon helmet armor function. Chance to burn item scales with enhancement level.    
    public fun helmet_armor_enhance_uncommon(
        armor: SuiWarlordArmorHelmet,
        accobj: &mut Account,
        mut payment: Coin<sui_warlords::time::TIME>,
        mut payment2: Coin<sui_warlords::uncommon::UNCOMMON>,               
    ...
    // Enhance rare helmet armor function. Chance to burn item scales with enhancement level.    
    public fun helmet_armor_enhance_rare(
        armor: SuiWarlordArmorHelmet,
        accobj: &mut Account,
        mut payment: Coin<sui_warlords::time::TIME>,
        mut payment2: Coin<sui_warlords::rare::RARE>,               
    ...
    // Enhance legendary helmet armor function. Chance to burn item scales with enhancement level.    
    public fun helmet_armor_enhance_legendary(
        armor: SuiWarlordArmorHelmet,
        accobj: &mut Account,
        mut payment: Coin<sui_warlords::time::TIME>,
        mut payment2: Coin<sui_warlords::legendary::LEGENDARY>,               
    ...
    // Enhance mythic helmet armor function. Chance to burn item scales with enhancement level.    
    public fun helmet_armor_enhance_mythic(
        armor: SuiWarlordArmorHelmet,
        accobj: &mut Account,
        mut payment: Coin<sui_warlords::time::TIME>,
        mut payment2: Coin<sui_warlords::mythic::MYTHIC>,               
    ...
    fun helmet_armor_enhance(armor: &mut SuiWarlordArmorHelmet) {
    ...
    public fun helmet_armor_burn(armor: SuiWarlordArmorHelmet, accobj: &mut Account, ctx: &mut TxContext) {
        ...
        let SuiWarlordArmorHelmet {id, style: _, gradestring: _, grade: _, bonus: _, enhancements: _, armorlevelphysical: _, armorlevelmagical: _, strength: _, endurance: _, dexterity: _, agility: _, intelligence: _, wisdom: _, vitality: _, luck: _} = armor;
        object::delete(id);                              
    }   
}