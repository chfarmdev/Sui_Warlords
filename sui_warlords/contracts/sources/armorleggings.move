...
module sui_warlords::armorleggings {    
    ...
    public fun get_leggings_armorlevelphysical(armor: &SuiWarlordArmorLeggings): u64 {
        armor.armorlevelphysical
    }

    public fun get_leggings_armorlevelmagical(armor: &SuiWarlordArmorLeggings): u64 {
