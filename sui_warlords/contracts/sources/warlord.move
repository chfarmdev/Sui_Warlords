...
module sui_warlords::warlord {   
    ...
    public struct SuiWarlordNFT has key, store {
        ...
        claimedblood: u64,
        claimedtime: u64,
        // Armorlevel of the Hero, modified by equipped armor
    ...
    // Soul Gem object, rewarded for burning Warlord NFT
    public struct SoulGem has key, store {
        id: UID,
        statbonus: u64,
    }   
    ...
    // Mint event
    public struct SuiWarlordMintEvent has copy, drop {
        object_id: ID,        
        creator: address,        
        name: String,        
        description: String,        
    ...
    // Level Up event
    public struct SuiWarlordLevelEvent has copy, drop {
        object_id: ID,       
        name: String,       
        strength: u64,
        endurance: u64,
    ...
    // Equip event
    public struct SuiWarlordEquipEvent has copy, drop {
        object_id: ID,        
        name: String,       
        armorlevelphysical: u64,
        armorlevelmagical: u64,       
    ...
    // Claim event
    public struct SuiWarlordClaimEvent has copy, drop {
        object_id: ID,      
        name: String,      
        claimedblood: u64,
        claimedtime: u64,
    ...
    // Class change event
    public struct SuiWarlordClassEvent has copy, drop {
        object_id: ID,      
        name: String,      
        class: String,
    }        
    ...
    public fun boots_equip(warlord: &mut SuiWarlordNFT, boots: SuiWarlordArmorBoots, ctx: &mut TxContext) {
        ...
        warlord.armorlevelphysical = warlord.armorlevelphysical + sui_warlords::armorboots::get_boots_armorlevelphysical(&boots);
        warlord.armorlevelmagical = warlord.armorlevelmagical + sui_warlords::armorboots::get_boots_armorlevelmagical(&boots);
        
        event::emit(SuiWarlordEquipEvent {
            object_id: object::id(warlord),            
            name: warlord.name,
            armorlevelphysical: warlord.armorlevelphysical,
            armorlevelmagical: warlord.armorlevelmagical,                 
    ...
    public fun chest_equip(warlord: &mut SuiWarlordNFT, chest: SuiWarlordArmorChest, ctx: &mut TxContext) {
        ...
        warlord.armorlevelphysical = warlord.armorlevelphysical + sui_warlords::armorchest::get_chest_armorlevelphysical(&chest);
        warlord.armorlevelmagical = warlord.armorlevelmagical + sui_warlords::armorchest::get_chest_armorlevelmagical(&chest);
    ...
    public fun gauntlets_equip(warlord: &mut SuiWarlordNFT, gauntlets: SuiWarlordArmorGauntlets, ctx: &mut TxContext) {
        ...
        warlord.armorlevelphysical = warlord.armorlevelphysical + sui_warlords::armorgauntlets::get_gauntlets_armorlevelphysical(&gauntlets);
        warlord.armorlevelmagical = warlord.armorlevelmagical + sui_warlords::armorgauntlets::get_gauntlets_armorlevelmagical(&gauntlets);
    ...
    public fun helmet_equip(warlord: &mut SuiWarlordNFT, helmet: SuiWarlordArmorHelmet, ctx: &mut TxContext) {
        ...
        warlord.armorlevelphysical = warlord.armorlevelphysical + sui_warlords::armorhelmet::get_helmet_armorlevelphysical(&helmet);
        warlord.armorlevelmagical = warlord.armorlevelmagical + sui_warlords::armorhelmet::get_helmet_armorlevelmagical(&helmet);
    ...
    public fun leggings_equip(warlord: &mut SuiWarlordNFT, leggings: SuiWarlordArmorLeggings, ctx: &mut TxContext) {
        ...
        warlord.armorlevelphysical = warlord.armorlevelphysical + sui_warlords::armorleggings::get_leggings_armorlevelphysical(&leggings);
        warlord.armorlevelmagical = warlord.armorlevelmagical + sui_warlords::armorleggings::get_leggings_armorlevelmagical(&leggings);
    ...
    // Get the Warlords physical armor level
    public fun get_armorlevelphysical(warlord: &SuiWarlordNFT): u64 {
        warlord.armorlevelphysical
    }

    // Get the Warlords magical armor level
    public fun get_armorlevelmagical(warlord: &SuiWarlordNFT): u64 {
        warlord.armorlevelmagical
    }
    ...
    public fun warlord_mint(
        ...
        event::emit(SuiWarlordMintEvent {
            object_id: object::id(&warlord),
            creator: sender,
            name: warlord.name,
            ...
            class: warlord.class,
            level: warlord.level,
            createtime: warlord.createtime,
            claimedblood: warlord.claimedblood,
            claimedtime: warlord.claimedtime,
            armorlevelphysical: warlord.armorlevelphysical,
            armorlevelmagical: warlord.armorlevelmagical,
            strength: warlord.strength,
            endurance: warlord.endurance,
        ...
        transfer::public_transfer(warlord, sender);
    }
    ...
    // Permanently burn Warlord in exchange for a Soul Gem
    // Soul Gems are used for enhanced leveling     
    
    public fun warlord_burn(warlord: SuiWarlordNFT, ctx: &mut TxContext) {
        let recipient = tx_context::sender(ctx);
        let bonus = warlord.level;

        let SuiWarlordNFT {id, name: _, description: _, class: _, level: _, createtime: _, claimedblood: _, claimedtime: _, armorlevelphysical: _, armorlevelmagical: _, strength: _, endurance: _, dexterity: _, agility: _, intelligence: _, wisdom: _, vitality: _, luck: _} = warlord;
        object::delete(id);      
        ...
        transfer::public_transfer(gem, recipient);
    }
    ...
    public fun warlord_claim_emission(warlord: &mut SuiWarlordNFT, accobj: &mut Account, clock: &Clock, ctx: &mut TxContext) {
        ...
        event::emit(SuiWarlordClaimEvent {
            object_id: object::id(warlord),           
            name: warlord.name,                       
            claimedblood: warlord.claimedblood,
            claimedtime: warlord.claimedtime,           
